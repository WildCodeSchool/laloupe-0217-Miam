angular.module('app').factory('FoodFactory', function() {
  return {
    Fruits: {
      ...
      aliments: [
        {
          ...
          suggestions: [
            "nature", "avec du sucre", "de la crème chantilly", "en tarte", "coulis ou confiture"
          ],
          composition: [""]
        }, {
          name: "Orange",
          ...
          suggestions: [
            "crue",
            "coupée en quartiers ou en rondelles",
            "en jus",
            "en salade",
            "zeste ou suprême",
            "marmelade",
          ...
          suggestions: [
            "crue", "cuite", "séchée", "en compote ou en tarte", "poire Belle-Hélène."
          ],
          composition: [""]
        }, {
          name: "Pomme",
      ...
      aliments: [
        {
          ...
          suggestions: [
            "cru nature ou avec un peu de sel", "mixé en purée froide", "en salade"
          ],
          composition: [""]
        }, {
          name: "Brocoli",
          ...
          suggestions: [
            "cru", "à l'eau ou à la vapeur", "en salade", "en gratin", "en purée"
          ],
          composition: [""]
        }, {
          name: "Carotte",
          ...
          suggestions: [
            "cru avec un peu de sel, de poivre et/ou de beurre", "trempé dans du fromage frais", "les fanes à l'étuvée en soupe ou velouté"
          ],
          composition: [""]
        }, {
          name: "Salade",
          ...
          suggestions: [
            ...
            "braisé",
            "en soupe",
            "hachée en accompagnement",
            "dans un sandwich",
            "en entrée ou avec le fromage"
          ],
          composition: [""]
        }, {
          name: "Tomate",
      ...
      aliments: [
        {
          ...
          suggestions: [
            "en galette 'fajitas'",
            "au barbecue, grillé en épis",
            "éclaté en Pop Corn",
            "cuisson au micro-ondes",
            "à la vapeur",
            "en flocon Corn Flakes",
            "en semoule Polenta",
            "en salade",
            "au four",
            "à l'eau"
          ...
          suggestions: [
            "nature", "grillé", "avec de la confiture", "avec du beurre"
          ],
          composition: ["Gluten"]
        }, {
          name: "Céréales",
          ...
          suggestions: [
            "seules", "avec du lait chaud ou froid", "en barres", "roses des sables", "nuggets de poulet"
          ],
          composition: ["Gluten"]
        }, {
          name: "Petits_pois",
          ...
          suggestions: [
            ...
            "paëlla",
            "risotto",
            "croquettes/galettes de légumes",
      ...
      aliments: [
        {
          ...
          suggestions: [
            "frais", "beurre doux, salé ou demi-sel", "sur tartine"
          ],
          composition: ["Lait"]
        }, {
          name: "Crème_fraîche",
          ...
          suggestions: [
            "en chantilly", "dans des crèmes sucrées ou salées"
          ],
          composition: ["Lait"]
        }, {
          name: "Emmental",
          ...
          suggestions: [
            "frais", "râpé dans les pâtes", "en salade", "sur tartine chaude"
          ],
          composition: ["Lait"]
        }, {
          name: "Fromage Blanc",
          ...
          suggestions: [
            "nature, au sucre ou avec des fruits", "en glace"
          ],
          composition: ["Lait"]
        }
      ]
      ...
      aliments: [
        {
          ...
          suggestions: [
            ...
            "badigeonné sur de la viande (boeuf, canard, ribs...)",
            "dans le yaourt ou dans le lait chaud",
            "dans un gâteau (pain d'épices, madeleines, sablés..)",
            "sur une tartine"
          ],
          composition: [""]
        }, {
          ...
          suggestions: [
            ...
            "blanc",
            "au lait",
            "contenant du riz soufflé, des céréales, des noisettes",
            "en mousse ou glace",
            "en tablette",
            "en pâte à tartiner",
            "avec du lait chaud",
            "dans un gâteau (fondant, moelleux, muffins, brownies...)"
          ],
          composition: [""]
        }, {
          name: "Confiture",
          ...
          suggestions: [
            "de fruits",
            "de lait",
            "sur une tartine de pain ou de brioche",
            "sur les crêpes ou gaufres",
            "dans le fromage blanc",
            "en gâteau (roulé, sablé, tarte, beignet, muffin, chausson...)"
          ],
          composition: [""]
        }, {
          ...
          suggestions: [
            "sur une tartine de pain ou de brioche", "sur une crêpe ou une gaufre", "avec des fruits", "en gâteau (fondant, moelleux, muffin, roulé...)"
          ],
          composition: [""]
        }, {
          name: "Petit_beurre",
          ...
          suggestions: [
            "nature", "dans un gâteau (crumble, moelleux, brownies, pudding, tiramisu, tarte, pop cake...)"
          ],
          composition: ["Gluten"]
        }
      ]
